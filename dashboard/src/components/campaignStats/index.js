                    ...
                    rankings && rankings.map(rank => (
                      <li className="stats__ranking">
                        <div className="stats__ranking-item">
                          <div className="stats__ranking-logo">
                          ...
                          <p>{capitalize(rank.username)}</p>
                          <div className="stats-tags">
                            <Tag color="blue">{rank.stats[Object.keys(rank.stats)[0]].clicks} clicks</Tag>
                            {
                              activeCampaign && (
                                <Tag color="blue">
                                  {
